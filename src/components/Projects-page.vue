    ...
    <div class="pre-projects PRO1">
      ...
      <div class="project-details mt-[35vh] md:mt-0">
        ...
        <div class="p-coder">
          ...
          <div class="text-3xl flex mt-3">
            <span class="iconify" data-icon="ci:adobe-xd"></span>
            <span class="text-2xl font-bold text-primaryTextTheme mx-2">|</span>
            <span
              class="iconify"
      ...
      <div class="project-details mt-[10vh] ">
        ...
        <div class="p-coder md:relative">
          <div class="md:absolute right-0">
            Designed &amp; Built with<br />
            <div class="text-3xl flex md:justify-end mt-3">
              <span class="iconify" data-icon="ph:figma-logo-light"></span>
              <span class="text-2xl font-bold text-primaryTextTheme mx-2"
                >|</span
              >
              <span
                class="iconify"
              ...
              <span
                class="iconify"
                data-icon="vscode-icons:file-type-node2"
              ></span>
              <span
                class="iconify"
